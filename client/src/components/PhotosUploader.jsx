          ...
          addedPhotos.map((link) => (
            <div className='h-32 flex relative' key={link}>
              ...
              <button
                ...
                className='absolute right-1 bottom-1 text-white bg-black bg-opacity-50 rounded-2xl p-2 hover:bg-opacity-100 cursor-pointer'
              >
                <svg
              ...
              <button
                ...
                className='absolute bottom-1 left-1 text-white bg-black bg-opacity-50 rounded-2xl p-2 hover:bg-opacity-100 cursor-pointer'
              >
                {link === addedPhotos[0] && (
                  <svg
                    xmlns='http://www.w3.org/2000/svg'
